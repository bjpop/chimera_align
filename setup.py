...
setup(
    name='chimera_align-py',
    version='0.1.0.0',
    author='Bernie Pope',
    author_email='bjpope@unimelb.edu.au',
    packages=['chimera_align'],
    package_dir={'chimera_align': 'chimera_align'},
    entry_points={
        'console_scripts': ['chimera_align-py = chimera_align.chimera_align:main']
    },
    url='https://github.com/bjpop/chimera_align',
    license='LICENSE',
