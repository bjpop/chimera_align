...
this_program_name="chimera_align-test.sh"
...
${this_program_name}: run integration/regression tests for chimera_align 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/chimera_align -d data/tests
